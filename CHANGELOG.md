...
## [Unreleased]
- **Retro TUI Overhaul**: Implemented a M.U.T.H.U.R style green-phosphor CRT dashboard built in native C++.
...
- **Directory Configuration**: Added interactive "ADD FILES TO PROCESS" page allowing users to configure, add, and delete multiple intelligence parsing directories dynamically.
